...
urlpatterns = [
    ...
    path('change_password/', views.rep_change_password, name='rep_change_password' ),
    ...
    path('password_reset/', auth_views.PasswordResetView.as_view(template_name='password_reset.html'), name='password_reset_view'),
